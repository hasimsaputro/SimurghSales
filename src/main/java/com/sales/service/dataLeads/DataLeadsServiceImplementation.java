    ...
    public void updateInsertDataLeads(DataLeadsFormDTO dataLeadsFormDTO) {
        ...
        if(isexist == false) {
            ...
            if(list.size() == 0){
                ...
                Integer newNomorAplikasi = Integer.parseInt(lastDataLead.getNomorAplikasi()) + 1;
